...
module.exports = {
    ...
    CreateDiscountInput: {
        ...
        properties: {
            ...
            claim_limit: {
                ...
                minimum: 1,
                nullable: true,
                description: "Maximum number of users who can claim this voucher. Null means unlimited.",
                example: 500,
            },
            is_stackable: { type: "boolean", default: false, example: false },
            stack_priority: { type: "integer", default: 0, example: 0 },
            show_on_homepage: { type: "boolean", default: false, example: true },
            requires_claim: { type: "boolean", default: false, example: true },
            homepage_priority: { type: "integer", minimum: 0, maximum: 999, default: 0, example: 10 },
    ...
    UpdateDiscountInput: {
        ...
        properties: {
            ...
            claim_limit: { type: "integer", minimum: 1, nullable: true },
            is_stackable: { type: "boolean" },
            stack_priority: { type: "integer" },
            show_on_homepage: { type: "boolean" },
            requires_claim: { type: "boolean" },
            homepage_priority: { type: "integer", minimum: 0, maximum: 999 },
    ...
    BulkDiscountInput: {
        ...
        properties: {
            ...
            claim_limit: { type: "integer", minimum: 1, nullable: true, example: 50 },
            is_stackable: { type: "boolean" },
            stack_priority: { type: "integer" },
            show_on_homepage: { type: "boolean" },
            requires_claim: { type: "boolean" },
    ...
    Discount: {
        ...
        properties: {
            ...
            claim_limit: { type: "integer", minimum: 1, nullable: true, example: 500 },
            claim_count: { type: "integer", minimum: 0, example: 120 },
            claim_remaining: { type: "integer", minimum: 0, nullable: true, example: 380 },
            is_stackable: { type: "boolean", example: false },
            stack_priority: { type: "integer", example: 0 },
            show_on_homepage: { type: "boolean", example: true },
            requires_claim: { type: "boolean", example: true },
            homepage_priority: { type: "integer", minimum: 0, maximum: 999, example: 10 },
            started_at: { type: "string", format: "date-time" },
            expiry_date: { type: "string", format: "date-time" },
    ...
    HomepageDiscount: {
        type: "object",
        required: ["id", "code", "type", "value", "display_value", "is_valid"],
        properties: {
            id: objectId(),
            code: { type: "string", example: "BAOTRAI10" },
            type: { type: "string", enum: discountTypeEnum, example: "percent" },
            value: { type: "number", minimum: 0, example: 10 },
            max_discount_amount: { type: "number", minimum: 0, nullable: true, example: 50000 },
            display_value: { type: "string", example: "10% off" },
            application_strategy: { type: "string", enum: applicationStrategyEnum, example: "apply_all" },
            application_strategy_label: { type: "string", example: "Apply to All Items" },
            applicable_targets: {
                type: "object",
                properties: {
                    type: { type: "string", enum: applicableTargetTypeEnum, example: "all" },
                    product_count: { type: "integer", minimum: 0, example: 0 },
                    category_count: { type: "integer", minimum: 0, example: 0 },
                    variant_count: { type: "integer", minimum: 0, example: 0 },
                },
            },
            user_eligibility: {
                type: "object",
                properties: {
                    type: { type: "string", enum: userEligibilityTypeEnum, example: "all" },
                    min_user_tier: { type: "string", enum: userTierEnum, nullable: true, example: null },
                },
            },
            requires_claim: { type: "boolean", example: true },
            min_order_value: { type: "number", minimum: 0, example: 300000 },
            usage_per_user_limit: { type: "integer", minimum: 1, example: 1 },
            is_stackable: { type: "boolean", example: false },
            claim_limit: { type: "integer", minimum: 1, nullable: true, example: 500 },
            claim_count: { type: "integer", minimum: 0, example: 120 },
            ...
            is_claimed: { type: "boolean", example: false },
            expiry_date: { type: "string", format: "date-time" },
            time_remaining: { type: "string", example: "12 days remaining" },
            warning: { type: "string", nullable: true, example: "Expires in 2 days" },
        },
    },

    ClaimedDiscount: {
        type: "object",
        required: ["id", "claim_id", "discount_id", "code", "status", "effective_status", "is_available"],
        properties: {
            id: objectId("507f1f77bcf86cd799439201"),
            claim_id: objectId("507f1f77bcf86cd799439201"),
            discount_id: objectId("507f1f77bcf86cd799439011"),
            code: { type: "string", example: "BAOTRAI10" },
            status: { type: "string", enum: ["claimed", "used", "expired", "revoked"], example: "claimed" },
            effective_status: { type: "string", enum: ["available", "used", "expired", "revoked"], example: "available" },
            is_available: { type: "boolean", example: true },
            used_count: { type: "integer", minimum: 0, example: 0 },
            remaining_user_uses: { type: "integer", minimum: 0, example: 1 },
            claimed_at: { type: "string", format: "date-time" },
            last_used_at: { type: "string", format: "date-time", nullable: true },
            used_at: { type: "string", format: "date-time", nullable: true },
            order_id: { ...objectId("507f1f77bcf86cd799439301"), nullable: true },
            discount: { $ref: "#/components/schemas/HomepageDiscount" },
            is_discount_active: { type: "boolean", example: true },
        },
    },
    ...
    DiscountUsageStats: {
        ...
        properties: {
            ...
            total_claimed: { type: "integer", minimum: 0, example: 120 },
            claim_limit: { type: "integer", minimum: 1, nullable: true, example: 500 },
    ...
    HomepageDiscountsResponse: {
        type: "object",
        required: ["success", "data"],
        properties: {
            success: { type: "boolean", example: true },
            data: { type: "array", items: { $ref: "#/components/schemas/HomepageDiscount" } },
        },
    },
    ...
    ClaimDiscountResponse: {
        ...
        properties: {
            success: { type: "boolean", example: true },
            message: { type: "string", example: "Voucher claimed successfully" },
            data: { $ref: "#/components/schemas/ClaimedDiscount" },
        },
    },

    ClaimedDiscountsResponse: {
        type: "object",
        required: ["success", "data", "pagination"],
        properties: {
            success: { type: "boolean", example: true },
            data: { type: "array", items: { $ref: "#/components/schemas/ClaimedDiscount" } },
            pagination,
        },
    },
