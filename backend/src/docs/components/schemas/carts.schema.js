...
module.exports = {
    CartItem: {
        ...
        properties: {
            ...
            original_price_at_added: { type: "number", example: 200000 },
            ...
            voucher_allowed: { type: "boolean", example: true },
            quantity: { type: "integer", example: 5 },
            original_line_total: { type: "number", example: 1000000 },
    ...
    CartTotals: {
        type: "object",
        properties: {
            original_subtotal: { type: "number", example: 1000000 },
            promotion_discount_amount: { type: "number", example: 100000 },
    ...
    CheckoutSnapshotItem: {
        ...
        properties: {
            ...
            original_price_at_added: { type: "number" },
            price_at_added: { type: "number" },
            promotion_discount_amount: { type: "number" },
            promotion_discount_percent: { type: "integer" },
            is_on_sale: { type: "boolean" },
            quantity: { type: "integer" },
            original_line_total: { type: "number" },
